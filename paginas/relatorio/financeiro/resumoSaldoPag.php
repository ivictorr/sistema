...
$filterFile = __DIR__ . "/filters/user_{$userId}_resaldopag.txt";
...
<div class="container mt-5">
    ...
    <div class="panel panel-primary no-print mt-5" style="margin-top: 30px">
        <div class="panel-heading text-center">
            <h3>RESUMO DE SALDO (CONTAS A PAGAR)</h3>
        </div>
        <br><br>
        <form method="POST" action="" class="form-horizontal">
            ...
            <div class="form-group row">
                <label for="formaCob-select" class="col-sm-2 col-form-label text-right">Forma de Pagamento:</label>
                <div class="col-sm-10">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-10">
                    <select id="tipoDocto-select" name="tipoDocto[]" class="selectpicker form-control" multiple data-live-search="true" title="Selecione uma ou mais opções">';
                        <?php
                        $res = $pdoS->query("SELECT DISTINCT A.Cod_docto AS DOC, B.Desc_documento AS NOME FROM tbTituloPag A
...
<div class="table-container">
    ...
    if (isset($_POST['gerarRelatorio'])):
        ...
        if (!empty($formaCob)) {
            $sql .= " AND A.Cod_forma_pgto IN ('" . implode("','", $formaCob) . "')";
        }
