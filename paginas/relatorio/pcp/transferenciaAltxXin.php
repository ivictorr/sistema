        ...
        <div class="panel-body">
            <form method="POST" action="" class="form-horizontal">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-6">
                        <input type="text" id="codigoPedXinguara" name="pedEntrada" class="form-control" placeholder="Romaneio Xinguara">
                    </div>
                </div>
...
WITH VolumesExclusivos AS (
    ...
    FROM 
        tbEntradas A
    INNER JOIN tbEntradasItemRom C ON A.Chave_fato = C.Chave_fato
